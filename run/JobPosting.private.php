...
$storage = $options->getTarget() === \SchemaTransformer\Run\Cli\Target::Typesense
    ? TypesenseStorageFactory::create(TypesenseCollection::JobPostingPrivate, [ 'filter_by' => '@type:=JobPosting' ], $logger)
