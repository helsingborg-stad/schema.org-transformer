...
use SchemaTransformer\Transforms\SponsorOfferTransform;
...
$storage        = StorageFactory::create(
    ...
    logger: $logger,
    options: [
        'collection'            => TypesenseCollection::SponsorOffer,
        'collectionClearFilter' => ['filter_by' => '@type:=SponsorOffer'],
    ],
);

$storage->store($reader->read());

(new Webhooks(logger: $logger))->trigger(getenv('WP_SPONSOR_OFFER_MONITOR_URL'));
